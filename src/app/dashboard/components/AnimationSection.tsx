        ...
        <div className="sticky top-0 lg:h-screen flex justify-center lg:items-center  px-8">
          <div className="max-w-7xl mx-auto w-full h-full flex flex-col">
            ...
            >
              <div>
                <motion.h2
                  className="text-5xl font-manrope font-light mb-4"
                ...
                <motion.p
                  className="text-5xl font-manrope font-light"
                  initial={{ translateY: 64, opacity: 0 }}
                  animate={{
                    translateY: state.isVisible ? 0 : 64,
                    opacity: state.isVisible ? 1 : 0,
                ...
                >
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div className="flex items-center">
                      ...
                      <div className="pl-[4%]" style={{ height: "340px" }}>
                          ...
                          {isPassengerSection(state.activeSection) && (
                            ...
                            >
                              <div className="pl-6">
                                ...
                                <p className="text-lg  transition-all duration-300 ease-out text-white font-normal">
